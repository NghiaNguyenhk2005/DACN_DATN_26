...
\begin{itemize}
    ...
    \item \textbf{Nhà bán và truy xuất nguồn gốc:} gian hàng, kết quả eKYC, chứng nhận kèm hạn hiệu lực, sản phẩm, bảng giá sỉ, lô hàng, mã QR và nhật ký canh tác theo lô.
    \item \textbf{Giao dịch:} giỏ hàng, đơn hàng chính/con, RFQ và lịch sử đàm phán, hợp đồng, đợt giao, công nợ, thanh toán và trạng thái ký quỹ.
    \item \textbf{Vận hành:} vận chuyển và lịch sử trạng thái, khiếu nại, đánh giá, điểm uy tín, tin nhắn, thông báo.
    \item \textbf{Quản trị và AI:} nhật ký thao tác quản trị, vi phạm, cảnh báo bất thường; lịch sử gợi ý, kết quả dự báo và phản hồi của người dùng/quản trị viên làm dữ liệu huấn luyện lại.
\end{itemize}
