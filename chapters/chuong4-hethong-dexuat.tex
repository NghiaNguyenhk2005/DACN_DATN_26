...
\begin{itemize}
    ...
    (ví dụ thêm vai trò quản trị chuyên biệt ngoài ba vai trò đã thiết kế tại
    mục~\ref{sec:doituongnguoidung}, hoặc mở thêm kênh bán mới) mà không
    thay đổi lớn hệ thống hiện có. Việc tách nhóm quản trị viên thành hai vai
    trò chuyên trách cộng một vai trò gộp quyền, theo phạm vi công việc, là
    minh chứng trực tiếp cho yêu cầu này.
