...
% TODO: nhóm bổ sung \parencite cho ba văn bản pháp lý dẫn dưới đây vào references.bib.
Pháp luật Việt Nam không có một định nghĩa duy nhất về ``nông sản'' áp dụng cho mọi mục đích. Đồ án xác định phạm vi dựa trên ba căn cứ: Luật An toàn thực phẩm số 55/2010/QH12 (khái niệm thực phẩm tươi sống và thực phẩm đã qua chế biến), Nghị định số 15/2018/NĐ-CP (phân loại sản phẩm phải công bố và sản phẩm được miễn), và Luật Trồng trọt số 31/2018/QH14 (sản phẩm cây trồng và sản phẩm sơ chế).
...
% TODO: nhóm bổ sung nguồn trích dẫn cho danh sách chứng nhận dưới đây (trang chính thức của GlobalG.A.P., GFSI, quy định hữu cơ của EU và Hoa Kỳ, chuẩn kiểm dịch thực vật quốc tế, và hướng dẫn mã số vùng trồng của cơ quan quản lý trong nước) rồi thêm \parencite tương ứng vào references.bib.
...
\begin{itemize}
    \item \textbf{GlobalG.A.P.} --- chuẩn thực hành nông nghiệp tốt được công nhận rộng rãi nhất trên thế giới, là điều kiện tiếp cận các thị trường khó tính; có thể bổ sung mô-đun GRASP đánh giá điều kiện lao động.
    \item \textbf{VietGAP} --- chuẩn trong nước, phù hợp chuỗi cung ứng nội địa.
    \item \textbf{Chứng nhận hữu cơ} --- USDA Organic (Hoa Kỳ), EU Organic theo Quy định 2018/848 (châu Âu), JAS Organic (Nhật Bản).
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{ISO 22000} và \textbf{FSSC 22000} --- hệ thống quản lý an toàn thực phẩm, trong đó FSSC 22000 được Sáng kiến An toàn Thực phẩm Toàn cầu (GFSI) công nhận.
    \item \textbf{BRCGS Food Safety} và \textbf{IFS Food} --- hai chuẩn được các chuỗi bán lẻ lớn tại Anh và châu Âu yêu cầu.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Giấy chứng nhận kiểm dịch thực vật} (Phytosanitary Certificate) --- bắt buộc với hầu hết lô hàng thực vật xuất khẩu, cấp theo chuẩn quốc tế về biện pháp kiểm dịch thực vật.
    ...
    \item \textbf{Mã số vùng trồng và mã số cơ sở đóng gói} --- điều kiện bắt buộc để xuất khẩu chính ngạch sang nhiều thị trường, trong đó có Trung Quốc.
...
Trợ lý ảo dựa trên xử lý ngôn ngữ tự nhiên (NLP) là một dạng hệ thống hội thoại (dialogue system); theo Jurafsky và Martin, các hệ thống này thường được phân theo hai kiến trúc chính: chatbot hướng mục tiêu (task-oriented, dùng để hoàn thành một tác vụ cụ thể như tra cứu đơn hàng) và chatbot trò chuyện mở (open-domain), trong đó phần lớn trợ lý ảo thương mại điện tử thuộc nhóm task-oriented với một tập intent (intent) và cơ sở tri thức giới hạn theo miền nghiệp vụ \parencite{jurafsky2023dialogue}. Với Farmery, trợ lý ảo task-oriented có thể hỗ trợ hai nhóm đối tượng: người mua (tư vấn chọn sản phẩm, giải đáp thắc mắc về truy xuất nguồn gốc, chính sách đổi trả) và nhà cung cấp (hướng dẫn quy trình đăng sản phẩm, ghi nhật ký canh tác, giải thích lý do bị từ chối kiểm duyệt). Việc thiết kế chatbot cho nhóm nông dân/HTX --- vốn có mức độ thành thạo công nghệ hạn chế như đã phân tích tại mục~\ref{sec:doituongnguoidung} --- cần ưu tiên giao diện hội thoại đơn giản, hỗ trợ giọng nói/ngôn ngữ địa phương nếu khả thi, và có cơ chế chuyển tiếp (escalation) sang nhân sự thật khi câu hỏi vượt phạm vi tập intent đã huấn luyện.
...
\begin{itemize}
    ...
    \item \textbf{Trí tuệ nhân tạo:} ba bài toán gợi ý sản phẩm, dự báo nhu cầu và giá, trợ lý ảo; cùng lý do giám sát bất thường được hiện thực bằng luật ngưỡng thay vì học máy trong phạm vi đồ án.
\end{itemize}
