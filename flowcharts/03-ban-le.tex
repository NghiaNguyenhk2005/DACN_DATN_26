...
\begin{tikzpicture}[farm/chart]
    ...
    \node[farm/process] (ready) at (0,-1.7) {Farmery: lô đã thu mua vào kho (Hình~\ref{fig:flow-thu-mua}) được mở bán với giá bán lẻ do bộ phận thu mua đặt};
    \node[farm/process] (browse) at (0,-3.75) {Khách lẻ: tìm kiếm, lọc, xem chi tiết và truy xuất nguồn gốc của lô};
    \node[farm/process] (cart) at (0,-5.7) {Khách lẻ: thêm vào giỏ theo tồn kho còn lại; chọn khung giờ giao và phương thức thanh toán};
    ...
    \node[farm/decision] (stock) at (0,-11) {Còn đủ\\tồn kho?};
    \node[farm/exception] (cancel) at (7,-13.5) {Hệ thống: hủy đơn, thông báo lý do; hoàn lại tồn kho đã giữ nếu có};
    \node[farm/process] (confirm) at (0,-13.5) {Hệ thống: xác nhận đơn và trừ tồn kho của lô trong một transaction có row-level lock, chống bán vượt khi lô đang bán song song ở kênh bán sỉ};
    ...
    \node[farm/note] at (2.7,-17.3) {\textbf{Đặt đồng thời:} ưu tiên đơn xác nhận trước khi trừ tồn kho; đơn còn lại bị hủy và thông báo hết hàng.};
