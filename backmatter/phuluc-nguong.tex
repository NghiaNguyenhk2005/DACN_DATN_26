...
\rowcolor{tblaltbg}
\textbf{NFR6.1--6.3} &
Trong usability test (usability test) với đại diện nhóm nông dân/HTX (mục~\ref{sec:danhgiaux}), task completion rate (task completion rate) cho luồng đăng bán sản phẩm và ghi nhật ký canh tác đạt tối thiểu 80\%, không cần người quan sát hỗ trợ trực tiếp. &
...
Ngưỡng độ tin cậy intent recognition (intent confidence) tối thiểu 70\% để hệ thống tự trả lời; dưới ngưỡng này, hội thoại được chuyển tiếp (escalate) sang nhân sự CSKH thật (mô tả tại mục dưới). &
